...
2. Si el flujo que enlaza una bobina de 75 vueltas (figura 13-29) cambia a la tasa
...
4. El flujo que cambia a una tasa uniforme por 1 ms induce 60 V en una bobina.
...
6. La corriente en un inductor de 75 mH (figura 13-30) cambia uniformemente
...
8. El voltaje inducido cuando la corriente cambia de forma uniforme de 3 a 5
...
10. Calcule la inductancia de la bobina de núcleo de aire de la figura 13-31, si
...
12. El inductor de núcleo de hierro de la figura 13-32 tiene un núcleo de alta permeabilidad.
...
14. La figura 13-34 muestra la corriente en una bobina. Si el voltaje de 0 a 2 ms
...
16. La figura 13-36 muestra la gráfica del voltaje en una inductancia. Los cambios
...
24. Una inductancia de 30 μH está conectada en serie con una inductancia de 60
...
26. Para los circuitos de la figura 13-40, determine L3 y L4.
...
28. Dos inductancias de 6 y 4 H están en conectadas en paralelo. Después de que se agrega una tercera inductancia, LT = 4 H. ¿Cuál es el valor de la tercera inductancia y como está conectada?
...
30. Inductancias de 8, 12 y 1.2 H están conectadas en un circuito. Si LT =6 H, ¿cómo están conectados los inductores
...
32. Por medio de la combinación de elementos, reduzca cada uno de los circuitos
...
34. Encuentre la energía almacenada en el inductor de la figura 13-44.
...
36. En la figura 13-46, un medidor de inductancia mide 7 H. ¿Cuál es la falla probable?
1. 
...
2. Repita el problema 2 si L1 se reemplaza con un capacitor descargado.
...
4. El interruptor de la figura 14-39 está cerrado en t = 0 s.
...
6. Repita el problema 5 para el circuito de la figura 14-41 con L = 4 H.
...
8. Cierre el interruptor en t = 0 s y determine las ecuaciones para iL y vL para el
...
10. Para el circuito de la figura 14-1(b), el voltaje en la inductancia en el instante en que el interruptor se cierra es 80 V, la corriente final de estado estable es 4 A, y el transitorio dura 0.5 s. Determine E, R y L.
...
12. Para la figura 14-1(b), si vL = 40e-2000t V y la corriente de estado estable es 10 mA, ¿cuales son los valores de E, R y L?
...
14. Para la figura 14-43, R1 = 20 Ω, R2 = 230 Ω y L = 0.5 H y la corriente del inductor ha alcanzado un valor estable de 5 A con el interruptor cerrado. En t = 0 s, el interruptor se abre.
...
16. Dado vL = -2700 Ve-100t. Use la curva universal de la constante de tiempo para determinar vL en t = 20 ms.

![image](https://user-images.githubusercontent.com/84425276/130546189-df97641b-0b98-4c6b-b5f0-a52802cb6510.png)

18. Para la figura 14-43, L = 20 H. La corriente durante la fase de crecimiento y disminución se muestra en la figura 14-44. Determine R1 y R2.
...
20. Para la bobina de la figura 14-45 Rl = 1.7 Ω y L = 150 mH. Determine la corriente de la bobina en t = 18.4 ms.
...
22. Para la figura 14-46, el circuito ha alcanzado el estado estable con el interruptor cerrado. Ahora se abre el interruptor.
...
26. El circuito de la figura 14-46 está en estado estable con el interruptor abierto. En t = 0, se cierra y permanece así. Grafique el voltaje en L y encuentre vL en 20 s con el cursor.
...
28. Para la figura 14-46, sea L1 = 30 mH y L2 = 90 mH. Cierre el interruptor en t = 0 y determine la corriente en el resistor de 30 Ω en t = 2ms.
...
- Entre más fuerte es el campo para una determinada corriente, más grande será
